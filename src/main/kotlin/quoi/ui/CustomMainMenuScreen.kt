...
class CustomMainMenuScreen(
    ...
    private var loadedImage: ResourceLocation? = null
    ...
    private fun drawCover(guiGraphics: GuiGraphics, image: ResourceLocation) {
    ...
    private fun background(): ResourceLocation? {
        ...
        loadedImage = runCatching {
            ...
            val id = ResourceLocation.fromNamespaceAndPath(QuoiMod.MOD_ID, "custom_main_menu_background")
