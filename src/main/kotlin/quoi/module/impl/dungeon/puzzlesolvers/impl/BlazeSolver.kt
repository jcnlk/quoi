...
object BlazeSolver : SettingGroup(PuzzleSolvers, "Blaze"), Repositionable { // todo cleanup/recode auto
    ...
    private val thirdColour by colourPicker("Third colour", Colour.MINECRAFT_RED.withAlpha(0.75f), desc = "Colour for the third blaze.").childOf(::solver)
    ...
    private val BLAZE_HEALTH_REGEX = Regex("^\\[Lv\\d+] . Blaze [\\d,]+/([\\d,]+)❤$")
