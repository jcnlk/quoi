...
import quoi.mixins.accessors.ServerboundInteractPacketAccessor
...
object AutoLeap : Module(
    ...
    init {
        ...
        on<PacketEvent.Sent, ServerboundInteractPacket> {
            ...
            val entityId = (packet as ServerboundInteractPacketAccessor).getEntityId()
            val armorStand = level.getEntity(entityId) as? ArmorStand ?: return@on
