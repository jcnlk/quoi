...
@Suppress("unused")
object Keybinds {
    val KEY_NONE: Int = InputConstants.UNKNOWN.value
    ...
    const val KEY_LEFT_SUPER: Int = InputConstants.KEY_LSUPER
    const val KEY_RIGHT_SUPER: Int = InputConstants.KEY_RSUPER
    ...
    val KEY_NUMPAD_SUBTRACT: Int = InputConstants.getKey("key.keyboard.keypad.subtract").value
    ...
    val KEY_MENU: Int = InputConstants.getKey("key.keyboard.menu").value
