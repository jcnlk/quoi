...
object Keybinds {
    ...
    const val KEY_LEFT_SHIFT: Int = GLFW.GLFW_KEY_LEFT_SHIFT
    const val KEY_RIGHT_SHIFT: Int = GLFW.GLFW_KEY_RIGHT_SHIFT
    const val KEY_LEFT_CONTROL: Int = GLFW.GLFW_KEY_LEFT_CONTROL
    const val KEY_RIGHT_CONTROL: Int = GLFW.GLFW_KEY_RIGHT_CONTROL
    const val KEY_LEFT_ALT: Int = GLFW.GLFW_KEY_LEFT_ALT
    const val KEY_RIGHT_ALT: Int = GLFW.GLFW_KEY_RIGHT_ALT
    const val KEY_LEFT_SUPER: Int = GLFW.GLFW_KEY_LEFT_SUPER
    const val KEY_RIGHT_SUPER: Int = GLFW.GLFW_KEY_RIGHT_SUPER
    const val KEY_CAPS_LOCK: Int = GLFW.GLFW_KEY_CAPS_LOCK
    const val KEY_NUM_LOCK: Int = GLFW.GLFW_KEY_NUM_LOCK
    const val KEY_SCROLL_LOCK: Int = GLFW.GLFW_KEY_SCROLL_LOCK
    ...
    const val KEY_PAGE_UP: Int = GLFW.GLFW_KEY_PAGE_UP
    const val KEY_PAGE_DOWN: Int = GLFW.GLFW_KEY_PAGE_DOWN
    ...
    const val KEY_EQUAL: Int = GLFW.GLFW_KEY_EQUAL
    const val KEY_LEFT_BRACKET: Int = GLFW.GLFW_KEY_LEFT_BRACKET
    const val KEY_BACKSLASH: Int = GLFW.GLFW_KEY_BACKSLASH
    const val KEY_RIGHT_BRACKET: Int = GLFW.GLFW_KEY_RIGHT_BRACKET
    const val KEY_GRAVE_ACCENT: Int = GLFW.GLFW_KEY_GRAVE_ACCENT

    const val KEY_NUMPAD_0: Int = GLFW.GLFW_KEY_KP_0
    const val KEY_NUMPAD_1: Int = GLFW.GLFW_KEY_KP_1
    const val KEY_NUMPAD_2: Int = GLFW.GLFW_KEY_KP_2
    const val KEY_NUMPAD_3: Int = GLFW.GLFW_KEY_KP_3
    const val KEY_NUMPAD_4: Int = GLFW.GLFW_KEY_KP_4
    const val KEY_NUMPAD_5: Int = GLFW.GLFW_KEY_KP_5
    const val KEY_NUMPAD_6: Int = GLFW.GLFW_KEY_KP_6
    const val KEY_NUMPAD_7: Int = GLFW.GLFW_KEY_KP_7
    const val KEY_NUMPAD_8: Int = GLFW.GLFW_KEY_KP_8
    const val KEY_NUMPAD_9: Int = GLFW.GLFW_KEY_KP_9

    const val KEY_NUMPAD_DECIMAL: Int = GLFW.GLFW_KEY_KP_DECIMAL
    const val KEY_NUMPAD_DIVIDE: Int = GLFW.GLFW_KEY_KP_DIVIDE
    const val KEY_NUMPAD_MULTIPLY: Int = GLFW.GLFW_KEY_KP_MULTIPLY
    const val KEY_NUMPAD_SUBTRACT: Int = GLFW.GLFW_KEY_KP_SUBTRACT
    const val KEY_NUMPAD_ADD: Int = GLFW.GLFW_KEY_KP_ADD
    const val KEY_NUMPAD_ENTER: Int = GLFW.GLFW_KEY_KP_ENTER
    const val KEY_NUMPAD_EQUAL: Int = GLFW.GLFW_KEY_KP_EQUAL

    const val KEY_PRINT_SCREEN: Int = GLFW.GLFW_KEY_PRINT_SCREEN
    const val KEY_PAUSE: Int = GLFW.GLFW_KEY_PAUSE
